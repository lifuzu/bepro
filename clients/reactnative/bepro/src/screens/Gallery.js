...
export default class GalleryScreen extends React.Component {
  ...
  saveToGallery = async () => {
    ...
    if (photos.length > 0) {
      ...
      await Promise.all(promises);  // eslint-disable-line  no-undef
      alert('Successfully saved photos to user\'s gallery!');  // eslint-disable-line  no-undef
    } else {
      alert('No photos to save!');  // eslint-disable-line  no-undef
    }
  };
  ...
  handleFaceDetectionError = error => console.warn(error);  // eslint-disable-line  no-undef
